...
class Avion extends Model
{
    ...
    // Si este no fuera el caso entonces hay qie indicar ccual es nuestra clave primaria en la tabla:
 ...
 */
 ...
 // Aui pnemos los campos qie no queremos que se devuelvan en las consultas
 ...
 // Definimos a continuación la relación de esta tabla con otras.
    ...
    //Relacion de Aviòn con Fabricante:
public function fabricante(){

    // 1 avion pertenece a un Fabricante
    // $this hace referencia al objeto que tengamos en  ese momento de Avion
